...
<input type="hidden" id="msg-trash" value="<?= _ht( 'Do you want to move the post to trash?' ) ?>">
<input type="hidden" id="msg-del-per" value="<?= _ht( 'Do you want to delete the post permanently?' ) ?>">
<input type="hidden" id="msg-empty-trash" value="<?= _ht( 'Do you want to empty trash?' ) ?>">
<?php \nt\end(); ?>
